...
{
    /// <summary>
    /// Interface to represent an entity (object) in a ray traced scene. All of
    /// our primitive types -- planes, triangles, spheres -- implement this
    /// interface. If you complete stage 3, you'll notice this interface is
    /// also used to implement 3D OBJ models.
    ///
    ...
    /// All that matters is that we can test if a ray collides with it, and the
    /// associated collision/hit information if it does. Furthermore, we need
    /// to be able to check what the material of the entity is in order to
    /// figure out how the ray should interact with it.
    /// </summary>
